...
import { InvoiceCostingSummary } from '@/components/invoice/InvoiceCostingSummary';
      ...
      <div className="space-y-6">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-card rounded-xl border border-border/50 p-0 overflow-hidden">
              <div className="bg-muted/30 px-4 py-3 flex gap-4">
                {[1, 2, 3, 4, 5].map(i => <Skeleton key={i} className="h-4 w-20 flex-1" />)}
              </div>
              {[1, 2, 3].map(i => (
                <div key={i} className="border-t border-border/30 px-4 py-4 flex gap-4">
