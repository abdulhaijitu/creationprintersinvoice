...
const Customers = () => {
  ...
  // Permission checks - use role-based consistently
  const canDelete = isAdmin || canRolePerform(orgRole as OrgRole, 'customers', 'delete');
  ...
  // Soft-delete — consistent with bulk delete behavior
  ...
  return (
    <div className="space-y-4 md:space-y-6 w-full min-w-0 animate-fade-in">
                ...
                <Table>
                  <TableHeader>
                    <TableRow className="bg-muted/30 hover:bg-muted/30">
                      ...
                      <TableHead className="font-semibold text-xs uppercase tracking-wide text-muted-foreground text-right w-[60px]">
                        Action
                      </TableHead>
                    </TableRow>
                  </TableHeader>
      ...
      <ConfirmDialog
        ...
        description="Are you sure you want to delete this customer? The customer will be archived and hidden from the list."
        confirmLabel="Delete"
        variant="destructive"
