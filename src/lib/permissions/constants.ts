...
export const PERMISSION_DEFINITIONS: PermissionDefinition[] = [
  ...
  { key: 'payments.create', module: 'payments', action: 'create', label: 'Create Payments', description: 'Add new payment records', category: 'MAIN' },
  { key: 'payments.edit', module: 'payments', action: 'edit', label: 'Edit Payments', description: 'Modify payment records', category: 'MAIN' },
  { key: 'payments.delete', module: 'payments', action: 'delete', label: 'Delete/Refund Payments', description: 'Delete or refund payment records', category: 'MAIN' },
  { key: 'payments.manage', module: 'payments', action: 'manage', label: 'Manage Payments', description: 'Full payment management (create, edit, refund)', category: 'MAIN' },
